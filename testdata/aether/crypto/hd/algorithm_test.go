...
import (
	...
	cryptocodec "github.com/aether/aether/v15/crypto/codec"
	enccodec "github.com/aether/aether/v15/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("aether", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, aethertypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
	...
	hdPath := aethertypes.BIP44HDPath
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, aethertypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(aethertypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Aether implementation
	...
	// Equality of Eth and Aether implementation
	...
	// Inequality of wrong derivation path of Eth and Aether implementation
