...
import (
	...
	"github.com/aether/aether/v15/wallets/ledger"
)

// AppName defines the Ledger app used for signing. Aether uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Aether:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Aether for the Ledger device:
	...
	// LedgerDerivation defines the Aether Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.AetherLedgerDerivation()
