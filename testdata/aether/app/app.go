...
import (
	...
	_ "github.com/aether/aether/v15/client/docs/statik"

	"github.com/aether/aether/v15/app/ante"
	ethante "github.com/aether/aether/v15/app/ante/evm"
	v10 "github.com/aether/aether/v15/app/upgrades/v10"
	v11 "github.com/aether/aether/v15/app/upgrades/v11"
	v12 "github.com/aether/aether/v15/app/upgrades/v12"
	v13 "github.com/aether/aether/v15/app/upgrades/v13"
	v14 "github.com/aether/aether/v15/app/upgrades/v14"
	v15 "github.com/aether/aether/v15/app/upgrades/v15"
	v8 "github.com/aether/aether/v15/app/upgrades/v8"
	v81 "github.com/aether/aether/v15/app/upgrades/v8_1"
	v82 "github.com/aether/aether/v15/app/upgrades/v8_2"
	v9 "github.com/aether/aether/v15/app/upgrades/v9"
	v91 "github.com/aether/aether/v15/app/upgrades/v9_1"
	"github.com/aether/aether/v15/encoding"
	"github.com/aether/aether/v15/ethereum/eip712"
	"github.com/aether/aether/v15/precompiles/common"
	srvflags "github.com/aether/aether/v15/server/flags"
	aethertypes "github.com/aether/aether/v15/types"
	"github.com/aether/aether/v15/x/claims"
	claimskeeper "github.com/aether/aether/v15/x/claims/keeper"
	claimstypes "github.com/aether/aether/v15/x/claims/types"
	"github.com/aether/aether/v15/x/epochs"
	epochskeeper "github.com/aether/aether/v15/x/epochs/keeper"
	epochstypes "github.com/aether/aether/v15/x/epochs/types"
	"github.com/aether/aether/v15/x/erc20"
	erc20client "github.com/aether/aether/v15/x/erc20/client"
	erc20keeper "github.com/aether/aether/v15/x/erc20/keeper"
	erc20types "github.com/aether/aether/v15/x/erc20/types"
	"github.com/aether/aether/v15/x/evm"
	evmkeeper "github.com/aether/aether/v15/x/evm/keeper"
	evmtypes "github.com/aether/aether/v15/x/evm/types"
	"github.com/aether/aether/v15/x/feemarket"
	feemarketkeeper "github.com/aether/aether/v15/x/feemarket/keeper"
	feemarkettypes "github.com/aether/aether/v15/x/feemarket/types"
	"github.com/aether/aether/v15/x/incentives"
	incentivesclient "github.com/aether/aether/v15/x/incentives/client"
	incentiveskeeper "github.com/aether/aether/v15/x/incentives/keeper"
	incentivestypes "github.com/aether/aether/v15/x/incentives/types"
	"github.com/aether/aether/v15/x/inflation"
	inflationkeeper "github.com/aether/aether/v15/x/inflation/keeper"
	inflationtypes "github.com/aether/aether/v15/x/inflation/types"
	"github.com/aether/aether/v15/x/recovery"
	recoverykeeper "github.com/aether/aether/v15/x/recovery/keeper"
	recoverytypes "github.com/aether/aether/v15/x/recovery/types"
	revenue "github.com/aether/aether/v15/x/revenue/v1"
	revenuekeeper "github.com/aether/aether/v15/x/revenue/v1/keeper"
	revenuetypes "github.com/aether/aether/v15/x/revenue/v1/types"
	"github.com/aether/aether/v15/x/vesting"
	vestingclient "github.com/aether/aether/v15/x/vesting/client"
	vestingkeeper "github.com/aether/aether/v15/x/vesting/keeper"
	vestingtypes "github.com/aether/aether/v15/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/aether/aether/v15/x/ibc/transfer"
	transferkeeper "github.com/aether/aether/v15/x/ibc/transfer/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".aetherd")

	// manually update the power reduction by replacing micro (u) -> atto (a) aether
	sdk.DefaultPowerReduction = aethertypes.PowerReduction
...
var (
	_ servertypes.Application = (*Aether)(nil)
	_ ibctesting.TestingApp   = (*Aether)(nil)
	_ runtime.AppI            = (*Aether)(nil)
)

// Aether implements an extended ABCI application. It is an application
...
func (*Aether) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewAether returns a reference to a new initialized Ethermint application.
func NewAether(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		aethertypes.ProtoAccount, maccPerms,
...
func (app *Aether) Name() string { return app.BaseApp.Name() }

func (app *Aether) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: aethertypes.HasDynamicFeeExtensionOption,
...
func (app *Aether) setPostHandler() {
...
func (app *Aether) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Aether) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Aether) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Aether) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Aether) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Aether) ModuleAccountAddrs() map[string]bool {
...
func (app *Aether) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Aether's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Aether) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Aether's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Aether) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Aether's InterfaceRegistry
func (app *Aether) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Aether) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Aether) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Aether) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Aether) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Aether) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Aether) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Aether) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Aether) RegisterNodeService(clientCtx client.Context) {
...
func (app *Aether) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Aether) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Aether) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Aether) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Aether) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Aether) GetTxConfig() client.TxConfig {
...
func (app *Aether) setupUpgradeHandlers() {
	// v8 upgrade handler
