...
// EthSetup initializes a new AetherApp. A Nop logger is set in AetherApp.
func EthSetup(isCheckTx bool, patchGenesis func(*Aether, simapp.GenesisState) simapp.GenesisState) *Aether {
	return EthSetupWithDB(isCheckTx, patchGenesis, dbm.NewMemDB())
}

// EthSetupWithDB initializes a new AetherApp. A Nop logger is set in AetherApp.
func EthSetupWithDB(isCheckTx bool, patchGenesis func(*Aether, simapp.GenesisState) simapp.GenesisState, db dbm.DB) *Aether {
	chainID := utils.TestnetChainID + "-1"
	app := NewAether(log.NewNopLogger(),
		db,
		nil,
		true,
		map[int64]bool{},
