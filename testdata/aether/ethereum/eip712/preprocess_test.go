...
import (
	...
	"github.com/aether/aether/v15/cmd/config"
	"github.com/aether/aether/v15/encoding"
	"github.com/aether/aether/v15/ethereum/eip712"
	utiltx "github.com/aether/aether/v15/testutil/tx"
...
var feePayerAddress = "aether17xpfvakm2amg962yls6f84z3kell8c5ljcjw34"
...
func createPopulatedTestCase(t *testing.T) TestCaseStruct {
	...
	msgSend := banktypes.MsgSend{
		...
		ToAddress:   "aether12luku6uxehhak02py4rcz65zu0swh7wjun6msa",
		Amount: sdk.NewCoins(
			sdk.NewCoin(
				utils.BaseDenom,
